...
function load () {
  ...
  chug([
    '/Users/sam/Projects/cute/cute.js',
    '/Users/sam/Projects/aframe/dist/aframe-master.js',
    'node_modules/tracking/src/tracking.js',
    '/Users/sam/Projects/tracking.js/build/tracking.js',
...
http.ServerResponse.prototype.view = function (name) {
  ...
  if (views[name]) {
    ...
    html = views.error404(state, state)
  }
